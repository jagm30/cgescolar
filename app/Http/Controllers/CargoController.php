...
class CargoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = Cargo::with(['inscripcion.alumno', 'inscripcion.grupo', 'concepto', 'detallesPagosVigentes'])
        ...
        // Agregar estado_real calculado
        $cargos->getCollection()->transform(fn($c) => array_merge($c->toArray(), [
            'estado_real'    => $c->estado_real,
            'saldo_pendiente'=> $c->saldo_pendiente_base,
        ]));
