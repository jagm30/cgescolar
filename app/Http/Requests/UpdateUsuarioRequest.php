...
class UpdateUsuarioRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'rol'      => ['sometimes', 'required', 'in:administrador,caja,recepcion,admisiones,informacion_admisiones,director_seccion,padre'],
            'activo'   => ['boolean'],
    ...
    public function messages(): array
    {
        return [
            ...
            'rol.in'                 => 'El rol debe ser: administrador, caja, recepcion, admisiones, informacion_admisiones, director_seccion o padre.',
        ];
    }
}
