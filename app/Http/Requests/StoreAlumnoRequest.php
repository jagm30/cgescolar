...
class StoreAlumnoRequest extends FormRequest
{
    ...
    {
        $contactos = collect($this->input('contactos', []))
    ...
    public function messages(): array
    {
        return [
            ...
            'curp.regex' => 'El formato de la CURP no es valido.',
            ...
            'contactos.max' => 'No puede registrar mas de 3 contactos familiares.',
            'contactos.*.nombre.required' => 'El nombre del contacto :position es obligatorio.',
            'contactos.*.telefono_celular.required' => 'El telefono celular del contacto :position es obligatorio.',
            ...
            'contactos.*.autorizado_recoger.boolean' => 'El campo "Autorizado para recoger" del contacto :position no es valido.',
            'contactos.*.es_responsable_pago.boolean' => 'El campo "Responsable de pagos" del contacto :position no es valido.',
            'contactos.*.tiene_acceso_portal.boolean' => 'El campo "Acceso al portal" del contacto :position no es valido.',
        ];
    }
}
