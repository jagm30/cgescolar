...
@section('page_title', 'Editar prospecto')
@section('page_subtitle', 'Datos de admisión')
...
<style>
    ...
    .pro-panel-body .form-group { margin-bottom: 10px; }
    ...
    .pro-errors strong { color: #c0392b; display: block; margin-bottom: 4px; }
    .pro-errors ul { margin: 0; padding-left: 18px; color: #a94442; }
</style>
@endpush
...
@section('content')
    ...
    <div class="pro-header">
        <h2>
            <i class="fa fa-pencil" style="color:#3c8dbc;margin-right:6px;"></i>
            Editar: {{ $prospecto->nombre_completo }}
        </h2>
        <a href="{{ route('prospectos.show', $prospecto->id) }}" class="btn btn-default btn-sm">
        ...
        <div class="pro-panel">
            ...
            <div class="pro-panel-body">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombre" name="nombre"
                                value="{{ old('nombre', $prospecto->nombre) }}" required maxlength="100"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="ap_paterno" name="ap_paterno"
                                value="{{ old('ap_paterno', $prospecto->ap_paterno) }}" required maxlength="100"
                                pattern="[A-Za-zÁÉÍÓÚáéíóúÑñ'\-\s]+" placeholder="Solo letras">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="ap_materno" name="ap_materno"
                                value="{{ old('ap_materno', $prospecto->ap_materno) }}" maxlength="100"
                                pattern="[A-Za-zÁÉÍÓÚáéíóúÑñ'\-\s]+" placeholder="Solo letras">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento"
                                value="{{ old('fecha_nacimiento', $prospecto->fecha_nacimiento?->format('Y-m-d')) }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="nivel_interes_id" name="nivel_interes_id">
                                ...
                                @foreach ($niveles as $nivel)
                                    <option value="{{ $nivel->id }}"
                                        {{ old('nivel_interes_id', $prospecto->nivel_interes_id) == $nivel->id ? 'selected' : '' }}>
                                        {{ $nivel->nombre }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="grado_interes_id">Grado de interés</label>
                            <select class="form-control" id="grado_interes_id" name="grado_interes_id">
                                <option value="">—</option>
                                @foreach ($grados as $grado)
                                    <option value="{{ $grado->id }}"
                                        data-nivel="{{ $grado->nivel_id }}"
                                        {{ old('grado_interes_id', $prospecto->grado_interes_id) == $grado->id ? 'selected' : '' }}>
                                        {{ $grado->numero }}°
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <select class="form-control" id="ciclo_id" name="ciclo_id">
                                ...
                                @foreach ($ciclos as $ciclo)
                                    <option value="{{ $ciclo->id }}"
                                        {{ old('ciclo_id', $prospecto->ciclo_id) == $ciclo->id ? 'selected' : '' }}>
                                        {{ $ciclo->nombre }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="contacto_nombre" name="contacto_nombre"
                                value="{{ old('contacto_nombre', $prospecto->contacto_nombre) }}" required maxlength="200"
                                pattern="[A-Za-zÁÉÍÓÚáéíóúÑñ'\-\s]+" placeholder="Solo letras">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" id="contacto_telefono" name="contacto_telefono"
                                value="{{ old('contacto_telefono', $prospecto->contacto_telefono) }}" required
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="fecha_primer_contacto"
                                ...
                                value="{{ old('fecha_primer_contacto', $prospecto->fecha_primer_contacto?->format('Y-m-d')) }}"
                                required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="contacto_email" name="contacto_email"
                                value="{{ old('contacto_email', $prospecto->contacto_email) }}" maxlength="200">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="canal_contacto" name="canal_contacto">
                                ...
                                @foreach ($canales as $valor => $etiqueta)
                                    <option value="{{ $valor }}"
                                        {{ old('canal_contacto', $prospecto->canal_contacto) === $valor ? 'selected' : '' }}>
                                        {{ $etiqueta }}
                                    </option>
                                @endforeach
                            </select>
            ...
            <div class="pro-panel-footer">
                <a href="{{ route('prospectos.show', $prospecto->id) }}" class="btn btn-default btn-sm">Cancelar</a>
...
<script>
    $(function() {
        ...
        var $gradoOptions = $gradoSelect.find('option[data-nivel]').clone();
        ...
        function filtrarGrados(nivelId) {
            ...
            $gradoSelect.append(opciones.clone());
        ...
        // Aplicar filtro inicial con el nivel actual del prospecto
