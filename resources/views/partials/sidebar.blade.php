        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <<<<<<< HEAD <li class="active">
                ...
                <li
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ request()->routeIs('ciclos.index') ? 'active' : '' }}"><a
                                href="{{ route('ciclos.index') }}"><i class="fa fa-circle-o"></i> Ciclos Escolares</a>
                        </li>
                        <li class="{{ request()->routeIs('datatables') ? 'active' : '' }}"><a
                                href="{{ route('datatables') }}"><i class="fa fa-circle-o"></i> Niveles Escolares</a>
                        </li>
                ...
                <li
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ request()->routeIs('tables') ? 'active' : '' }}"><a
                                href="{{ route('tables') }}"><i class="fa fa-circle-o"></i> Tablas</a></li>
                        <li class="{{ request()->routeIs('datatables') ? 'active' : '' }}"><a
