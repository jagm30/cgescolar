        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li
                ...
                <ul class="treeview-menu">
                    <li class="{{ request()->routeIs('ciclos.index') ? 'active' : '' }}"><a
                            href="{{ route('ciclos.index') }}"><i class="fa fa-circle-o"></i>Ciclos Escolares</a></li>
                    <li class="{{ request()->routeIs('niveles.index') ? 'active' : '' }}"><a
                            href="{{ route('niveles.index') }}"><i class="fa fa-circle-o"></i> Niveles Escolares</a>
                    </li>
                    <li class="{{ request()->routeIs('grados.index') ? 'active' : '' }}"><a
                            href="{{ route('grados.index') }}"><i class="fa fa-circle-o"></i> Grados</a></li>
                    <li class="{{ request()->routeIs('grupos.index') ? 'active' : '' }}"><a
                            href="{{ route('grupos.index') }}"><i class="fa fa-circle-o"></i> Grupos</a></li>
                </ul>
            </li>
            <li
                class="treeview {{ request()->routeIs(['alumnos.index', 'alumnos.create']) ? 'active menu-open' : '' }}">
                <a href="#">
                    <i class="fa fa-users"></i>
                    <span>Alumnos</span>
                    <span class="pull-right-container">
                ...
                <ul class="treeview-menu">
                    <li class="{{ request()->routeIs('alumnos.index') ? 'active' : '' }}"><a
                            href="{{ route('alumnos.index') }}"><i class="fa fa-circle-o"></i> Lista de Alumnos</a>
                    </li>
                    <li class="{{ request()->routeIs('alumnos.create') ? 'active' : '' }}"><a
                            href="{{ route('alumnos.create') }}"><i class="fa fa-circle-o"></i> Registrar Nuevo</a>
                    </li>
                </ul>
            </li>
            <li
