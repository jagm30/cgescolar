                ...
                <form action="{{ route('personal.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('numero_empleado') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" name="numero_empleado" class="form-control"
                                        value="{{ old('numero_empleado') }}" placeholder="Ej: EMP-001" maxlength="20"
                                        required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('rfc') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" name="rfc" class="form-control" value="{{ old('rfc') }}"
                                        maxlength="13" placeholder="Ej: LOAM850101AB1" style="text-transform:uppercase;">
                                    @error('rfc')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group {{ $errors->has('domicilio') ? 'has-error' : '' }}">
                            ...
                            <textarea name="domicilio" class="form-control" rows="2" maxlength="500"
                                placeholder="Calle, número, colonia, ciudad…">{{ old('domicilio') }}</textarea>
                            @error('domicilio')
                                <span class="help-block">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('foto') ? 'has-error' : '' }}">
                            <label><i class="fa fa-camera"></i> Foto <small class="text-muted">(opcional, máx. 2
                                    MB)</small></label>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function toggleRoles() {
                if (chkAcceso.checked) {
                    ...
                    selectRol.value = ''; // Limpiar el select si desmarcan
                }
            }
