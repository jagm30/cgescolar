...
@section('page_title', 'Configurar Políticas')
...
@section('breadcrumb')
    ...
    <li class="active">Políticas y Recargos</li>
@endsection
...
@push('styles')
    <style>
        ...
        /* ── Ajustes para que los Tabs se vean limpios ── */
        .nav-tabs-custom {
        ...
        .politica-card.recargo {
            border-left-color: #e74c3c;
        }

        .politica-card.inactiva {
            opacity: .55;
        }
        ...
        .form-card.recargo-form {
            border-color: #f5c6c6;
            background: #fff8f8;
        }

        .form-card.recargo-form .form-card-titulo {
            color: #c0392b;
        }
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="active">
                <a href="#tab_politicas" data-toggle="tab">
                    <i class="fa fa-percent text-blue"></i> <strong>2. Políticas y Recargos</strong>
                </a>
            </li>
        </ul>
        ...
        <div class="tab-content">
            ...
            ════════════════════════════════════════════════════ --}}
                    <div class="col-md-7">
                        ...
                        {{-- ── DESCUENTOS ── --}}
                        <div class="box box-primary" style="border-radius: 6px;">
                            <div class="box-header with-border">
                                ...
                                <div class="box-tools pull-right">
                                    <button type="button" class="btn btn-primary btn-sm" id="btn-nuevo-descuento"
                                        ...
                                        <form id="form-descuento" autocomplete="off">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="number" id="desc-dia" class="form-control"
                                                                placeholder="Ej: 5 (día 5 de cada mes)" min="1"
                                                                max="31">
                                            ...
                                            <div class="simulador" id="simulador-desc" style="display:none;">
                                                <div class="simulador-titulo">
                                                    ...
                                                    <input type="number" id="sim-desc-base"
                                ...
                                <div id="lista-descuentos">
                                    @forelse($plan->politicasDescuento as $desc)
                                        <div class="politica-card {{ !$desc->activo ? 'inactiva' : '' }}"
                                            data-id="{{ $desc->id }}" data-nombre="{{ $desc->nombre }}"
                                            data-tipo="{{ $desc->tipo_valor }}" data-valor="{{ $desc->valor }}"
                                            ...
                                            <div style="flex:1;min-width:0;">
                                                ...
                                                <div class="politica-detalle">
                                                    @if ($desc->dia_limite)
                                                        <span
                                                            style="background:#f0f0f0;padding:1px 7px;border-radius:8px;font-size:10px;">
                                                            <i class="fa fa-calendar"></i>
                                                    ...
                                                    @if (!$desc->activo)
                                                        <span
                                                            style="background:#f5f5f5;color:#999;padding:1px 7px;border-radius:8px;font-size:10px;">
                                                            Inactivo
                                                        </span>
                                                    @endif
                                                </div>
                                            ...
                                            <div style="flex-shrink:0;display:flex;gap:4px;margin-left:10px;">
                                                <button type="button"
                                                    class="btn btn-default btn-xs btn-flat btn-editar-desc"
                                                    data-id="{{ $desc->id }}" title="Editar">
                                                    <i class="fa fa-pencil"></i>
                                                </button>
                                                <button type="button"
                                                    class="btn btn-danger btn-xs btn-flat btn-eliminar-desc"
                                                    data-id="{{ $desc->id }}" data-nombre="{{ $desc->nombre }}"
                                                    title="Eliminar">
                        ...
                        {{-- ── POLÍTICA DE RECARGO ── --}}
                        <div class="box" style="border-top:3px solid #e74c3c; border-radius: 6px;">
                            <div class="box-header with-border">
                                ...
                                <div class="box-tools pull-right">
                                    @if (!$plan->politicaRecargo)
                                        <button type="button" class="btn btn-danger btn-sm" id="btn-nuevo-recargo"
                                            style="border-radius: 4px;">
                            ...
                            <div class="box-body">
                                ...
                                <div class="alert alert-warning" style="font-size:12px;margin-bottom:14px;">
                                    ...
                                    El recargo se aplica automáticamente cuando el pago se realiza después del día límite
                                    configurado.
                                </div>

                                {{-- Formulario de recargo (oculto) --}}
                                <div id="form-recargo-wrap"
                                    style="{{ $plan->politicaRecargo ? 'display:none;' : ($plan->politicasDescuento->count() ? 'display:none;' : 'display:none;') }}">
                                            ...
                                            <div class="simulador" id="simulador-rec"
                                                ...
                                                <div class="simulador-titulo">
                                                    ...
                                                    <span id="sim-rec-meses-wrap" style="display:none;">
                                                        &nbsp;·&nbsp; Meses de retraso:
                                                        <input type="number" id="sim-rec-meses"
                                                            class="form-control input-sm"
                                                ...
                                                <div class="simulador-fila" style="color:#e74c3c;">
                                                    <span>Recargo por mora <span id="sim-rec-meses-label"
                                                            style="display:none;font-size:11px;"></span></span>
                                ...
                                <div id="tarjeta-recargo">
                                    @if ($plan->politicaRecargo)
                                        ...
                                        <div class="politica-card recargo {{ !$rec->activo ? 'inactiva' : '' }}"
                                            id="rec-card-{{ $rec->id }}" data-id="{{ $rec->id }}"
                                            ...
                                            <div class="politica-icono" style="background:#fdecea;">
                                                <i class="fa fa-exclamation-triangle"
                                                    style="color:#e74c3c;font-size:17px;"></i>
                                            </div>
                                            ...
                                            <div style="flex:1;min-width:0;">
                                                ...
                                                <div class="politica-detalle">
                                                    <span
                                                        style="background:#fdecea;color:#c0392b;padding:1px 8px;border-radius:8px;font-size:11px;font-weight:600;">
                                                        <i class="fa fa-calendar"></i>
                                                        Aplica después del día {{ $rec->dia_limite_pago }}
                                                    </span>
                                                    @if ($rec->acumular_mensual)
                                                        <span
                                                            style="background:#fff3cd;color:#856404;padding:1px 8px;border-radius:8px;font-size:11px;margin-left:8px;">
                                                    ...
                                                    @if (!$rec->activo)
                                                        <span
                                                            style="background:#f5f5f5;color:#999;padding:1px 7px;border-radius:8px;font-size:10px;margin-left:4px;">
                                                            Inactivo
                                                        </span>
                                                    @endif
                                                </div>
                                            ...
                                            <div style="flex-shrink:0;display:flex;gap:4px;margin-left:10px;">
                                                ...
                                                <button type="button" class="btn btn-danger btn-xs btn-flat"
                                                    id="btn-eliminar-rec" data-id="{{ $rec->id }}"
                                    ...
                                    @else
                                        <div style="text-align:center;padding:30px 0;color:#ccc;" id="empty-recargo">
                                            <i class="fa fa-exclamation-triangle"
                                                style="font-size:28px;display:block;margin-bottom:8px;color:#f5c6c6;"></i>
            ...
            ════════════════════════════════════════════════════ --}}
                    <div class="col-md-5">
                        ...
                        {{-- Resumen del plan --}}
                        <div class="box box-default" style="border-radius: 6px;">
                            <div class="box-header with-border">
                                        ...
                                        <td style="padding:10px 16px;">
                                            ...
                                            @if ($plan->politicasDescuento->where('activo', true)->count() < $plan->politicasDescuento->count())
                                                <small style="color:#aaa;">
                                                    ({{ $plan->politicasDescuento->where('activo', true)->count() }}
                                                    activos)
                                                </small>
                                            @endif
                                        </td>
                        ...
                        <div class="box box-default" style="border-radius: 6px;">
                            ...
                            <div class="box-body" style="font-size:12px;line-height:1.8;color:#555;">
                                ...
                                <div
                                    style="background:#f0f7ff;border-left:3px solid #3c8dbc;padding:8px 12px;border-radius:0 4px 4px 0;margin-bottom:12px;">
                                    ...
                                    <strong>Sin día límite:</strong> el descuento aplica siempre que el cajero lo
                                    seleccione.
                                </div>

                                <p style="margin:0 0 10px;">
                                    <strong style="color:#e74c3c;"><i class="fa fa-exclamation-triangle"></i> Recargo por
                                        mora</strong><br>
                                ...
                                <div
                                    style="background:#fff8f8;border-left:3px solid #e74c3c;padding:8px 12px;border-radius:0 4px 4px 0;">
                        ...
                        <div class="box box-default" style="border-radius: 6px;">
                            ...
                            <div class="box-body" style="font-size:13px;">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">$</span>
                                        <input type="number" id="calc-base" class="form-control" value="1000"
                                            min="1" step="0.01">
                                    </div>
                                </div>
                                ...
                                @if ($plan->politicasDescuento->where('activo', true)->count())
                                    <div style="margin-bottom:14px;">
                                        <div
                                            style="font-size:11px;text-transform:uppercase;color:#aaa;margin-bottom:6px;letter-spacing:.05em;">
                                            Con descuento
                                        </div>
                                        @foreach ($plan->politicasDescuento->where('activo', true) as $d)
                                            <div
                                                style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid #f5f5f5;font-size:12px;">
                                                <span>{{ $d->nombre }}</span>
                                                <span style="color:#3c8dbc;font-weight:600;"
                                                    id="calc-desc-{{ $d->id }}" data-tipo="{{ $d->tipo_valor }}"
                                                    data-valor="{{ $d->valor }}">
                                                    —
                                                </span>
                                            </div>
                                ...
                                @if ($plan->politicaRecargo)
                                    ...
                                    <div>
                                        ...
                                        <div
                                            style="display:flex;justify-content:space-between;padding:5px 0;font-size:12px;">
                                            <span>Recargo</span>
                                        ...
                                        <div
                                            style="display:flex;justify-content:space-between;padding:5px 0;font-size:13px;font-weight:700;border-top:2px solid #eee;margin-top:4px;">
        ...
        $(function() {
            ...
            function setupTipo(prefixId, opt1Id, opt2Id, onCambio) {
                $(document).on('change', 'input[name="' + prefixId + '"]', function() {
                    ...
                    $(this).closest('label').addClass(prefixId === 'desc_tipo' ? 'activo-desc' :
                        'activo-rec');
            ...
            $(document).on('click', '.btn-editar-desc', function() {
                ...
                $('#form-nuevo-descuento').slideDown(200);
                $('html,body').animate({
                    scrollTop: $('#form-nuevo-descuento').offset().top - 80
                }, 200);
                $('#desc-nombre').focus();
            });
            ...
            $('#form-descuento').on('submit', function(e) {
                ...
                if (!nombre) {
                    mostrarAlerta('El nombre del descuento es obligatorio.', 'danger');
                    return;
                }
                if (!tipo) {
                    mostrarAlerta('Selecciona el tipo de descuento.', 'danger');
                    return;
                }
                if (!valor || parseFloat(valor) <= 0) {
                    mostrarAlerta('El valor debe ser mayor a cero.', 'danger');
                    return;
                }
                if (tipo === 'porcentaje' && parseFloat(valor) > 100) {
                    mostrarAlerta('El porcentaje no puede superar 100.', 'danger');
                    return;
                }
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        $btn.closest('.politica-card').fadeOut(250, function() {
                            $(this).remove();
                            if (!$('.politica-card').length) $('#empty-descuentos')
                                .show();
                        });
                    ...
                    error: function(xhr) {
                        ...
                        mostrarAlerta(xhr.responseJSON?.message || 'Error al eliminar.',
                            'danger');
                    }
                });
            });
            ...
            $('#btn-editar-rec').on('click', function() {
                ...
                $('#form-recargo-wrap').slideDown(200);
                $('html,body').animate({
                    scrollTop: $('#form-recargo-wrap').offset().top - 80
                }, 200);
            });
            ...
            $('#form-recargo').on('submit', function(e) {
                ...
                if (!dia) {
                    mostrarAlerta('El día límite es obligatorio.', 'danger');
                    return;
                }
                if (!tipo) {
                    mostrarAlerta('Selecciona el tipo de recargo.', 'danger');
                    return;
                }
                if (!valor || parseFloat(valor) <= 0) {
                    mostrarAlerta('El valor debe ser mayor a cero.', 'danger');
